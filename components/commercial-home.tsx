  ...
  es: {
    ...
    problem: {
      ...
      pairs: [
        ...
        { problem: "Manuales y procedimientos dispersos", solution: "Talkey convierte manuales, procedimientos y experiencia técnica —incluido el conocimiento concentrado en especialistas— en una base aprobada y reutilizable que entrega respuestas claras y pasos concretos durante la atención y las llamadas." },
        { problem: "Usuarios que esperan respuestas inmediatas", solution: "Talkey inicia la atención 24/7 por chat o voz, con respuestas pacientes, consistentes y basadas en conocimiento aprobado; resuelve consultas frecuentes y deriva con contexto cuando se necesita una persona." },
