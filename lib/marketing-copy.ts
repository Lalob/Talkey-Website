  ...
  es: {
    ...
    chat: {
      ...
      responses: {
        ...
        implementation: "La implementación suele avanzar en etapas simples: revisar el flujo de soporte, ordenar el conocimiento disponible, configurar respuestas y criterios de derivación, probar casos reales y ajustar antes de salir a producción. Si quieres verlo aplicado a tu empresa, solicita una evaluación.",
        implementationFollowUp: "En más detalle: primero se define el flujo de soporte, luego se estructura el conocimiento, se configuran criterios de respuesta y derivación, se prueban casos reales y se ajusta el sistema antes de operar. Si quieres revisar cómo sería en tu empresa, solicita una evaluación.",
        ...
        whatsapp: "Sí, puede funcionar con WhatsApp. La configuración exacta se revisa en una evaluación para asegurar que el flujo quede bien conectado a tu operación.",
        ...
        fallback: "Talkey responde desde conocimiento aprobado, guía diagnósticos y deriva con contexto cuando el caso necesita una persona. Si quieres verlo aplicado a tu empresa, solicita una evaluación.",
      },
    },
    metrics: [
